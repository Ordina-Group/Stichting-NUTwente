...
public class MailHelper
{
    ...
    {
        List<string> AdressesToLower = new List<string>();
        foreach (string adress in mailAdresses)
        {
            AdressesToLower.Add(adress.ToLower());
        }
        mailAdresses = AdressesToLower.Distinct().ToList();
