...
namespace Ordina.StichtingNuTwente.Data.Migrations
{
    ...
    [Migration("20220805112625_renamedBegeleiderToIntaker")]
    partial class renamedBegeleiderToIntaker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordina.StichtingNuTwente.Models.Models.Gastgezin", b =>
                {
                    ...
                    b.Property<string>("CoordinatorOpmerkingen")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("IntakerId")
                        .HasColumnType("int");

                    b.Property<int?>("MaxOlderThanTwo")
                        .HasColumnType("int");

                    b.Property<int?>("MaxYoungerThanThree")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("OnHoldTill")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Ordina.StichtingNuTwente.Models.Models.Plaatsing", b =>
                {
                    ...
                    b.Property<string>("DepartureComment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("DepartureDestination")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordina.StichtingNuTwente.Models.Models.PlaatsingsInfo", b =>
                {
                    ...
                    b.Property<string>("BezwaarTegenHuisdieren")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ordina.StichtingNuTwente.Models.Models.Gastgezin", b =>
                {
                    ...
                    b.HasOne("Ordina.StichtingNuTwente.Models.Models.UserDetails", "Intaker")
                        .WithMany()
                        .HasForeignKey("IntakerId");
            ...
            modelBuilder.Entity("Ordina.StichtingNuTwente.Models.Models.UserDetails", b =>
                {
                    b.HasOne("Ordina.StichtingNuTwente.Models.Models.Adres", "Address")
                        .WithMany()
